            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ma_sp') is-invalid @enderror" name="ma_sp" placeholder="Nhập mã sản phẩm">
                        @error('ma_sp')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('so_luong') is-invalid @enderror" name="so_luong" placeholder="Nhập số lượng">
                        @error('so_luong')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('gia_san_pham') is-invalid @enderror" name="gia_san_pham" placeholder="nhập giá sản phẩm">
                        @error('gia_san_pham')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('gia_khuyen_mai') is-invalid @enderror" name="gia_khuyen_mai" placeholder="Nhập giá khuyễn mãi">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('ngay_nhap') is-invalid @enderror"  name="ngay_nhap" placeholder="Nhập ngày nhập">
                        @error('ngay_nhap')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('mo_ta') is-invalid @enderror" aria-label="With textarea" name="mo_ta"></textarea>
                        @error('mo_ta')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <tbody id="image_table_body">
                                <tr>
                                    <td class="d-flex algin-items-center">
                                        <img id="preview_0" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0Wr3oWsq6KobkPqznhl09Wum9ujEihaUT4Q&s" alt="hình ảnh danh mục" style="width: 50px;" class="me-3">
                                        <input type="file" class="form-control" name="list_hinh_anh[id_0]" onchange="previewImage(this, 0)">
                                    </td>
                                    <td>
                                        <i class="mdi mdi-delete text-muted fs-18 rounded-2 border ms-3 p-1" style="cursor: pointer"></i>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
